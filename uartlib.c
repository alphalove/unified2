...
/*********************************************************************
 * Put one character to device, timeout (blocking)
 *********************************************************************/
void
putc_uartNR(uint32_t uartno,char ch) {
	uint32_t uart = uarts[uartno-1].usart;
...
uart1_vprintf(const char *format,va_list ap) {
	...
	// AMS here too
	return mini_vprintf_uncooked(uart1_putc,format,ap);
}

int
uart1_vprintfNR(const char *format,va_list ap) {
	//return mini_vprintf_cooked(uart1_putc,format,ap);
	// AMS here too
	return mini_vprintf_uncooked(uart1_putcNR,format,ap);
}
...
// ok, mcuio std_printf calls vprintf
int
uart2_vprintf(const char *format,va_list ap) {
	//return mini_vprintf_cooked(uart1_putc,format,ap);
	// AMS was here
	return mini_vprintf_uncooked(uart2_putc,format,ap);
}

int
uart2_vprintfNR(const char *format,va_list ap) {
	//return mini_vprintf_cooked(uart1_putc,format,ap);
	// AMS was here
	return mini_vprintf_uncooked(uart2_putcNR,format,ap);
}
...
int
uart3_vprintfNR(const char *format,va_list ap) {
	//return mini_vprintf_cooked(uart1_putc,format,ap);
	return mini_vprintf_cooked(uart3_putcNR,format,ap);
}
